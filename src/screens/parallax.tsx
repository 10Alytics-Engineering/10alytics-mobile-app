    ...
    <>
      ...
      <View className="flex-1 relative bg-background">
        <Animated.FlatList
            ...
            return (
              ...
              >
                ...
                <Animated.View className="items-center justify-center">
                  <Text className="text-2xl font-bold mt-4 text-text">
                    {item.title}
                  </Text>
                  <Text className="text-center text-text opacity-50 mt-2">
                    {item.description}
                  </Text>
                </Animated.View>
              </View>
          ...
          ListFooterComponent={() => <View className="w-full h-28" />}
        ...
        <View className="w-full px-6 mb-global flex flex-col space-y-2">
          <View className="flex flex-row items-center justify-center gap-2">
            ...
            <Pressable
              ...
              className="flex-1 w-1/4 bg-text rounded-full flex flex-row items-center justify-center py-4"
            >
              <Feather name="mail" size={20} color={colors.invert} />
            </Pressable>
            <Pressable
              onPress={() => router.push("/sign-in")}
              className="flex-1 border border-black border-border rounded-full flex flex-row items-center justify-center py-4"
            >
